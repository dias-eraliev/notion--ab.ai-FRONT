    ...
    <div className="h-12 flex items-center justify-between px-4 border-b border-gray-200">
      ...
      <div className="flex items-center flex-1">
        <div className="relative max-w-[240px]">
          ...
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-1.5 text-sm border border-transparent rounded-xs bg-gray-100 placeholder-gray-400 focus:outline-hidden focus:bg-white focus:border-gray-200"
