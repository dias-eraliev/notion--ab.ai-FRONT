        ...
        <div className="p-6">
                ...
                <>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {students?.Parent && students?.Parent.length > 0 ? (
                                <>
                                    {students?.Parent.some(parent => parent.relation === "FATHER") && (
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <button
                                                    onClick={() => handleChatWithParent(
                                                        "FATHER",
                                                        students?.Parent.find(parent => parent.relation === "FATHER")?.user?.username || "Undefined"
                                                    )}
                                            ...
                                            <div className="space-y-2">
                                                <p className="text-sm text-gray-600">
                                                    {students?.Parent.find(parent => parent.relation === "FATHER")?.user?.username}
                                                </p>
                                            </div>
                                        </div>
                                    )}

                                    {students?.Parent.some(parent => parent.relation === "MOTHER") && (
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center">
                                                    <FaUserGraduate className="w-5 h-5 text-gray-500"/>
                                                ...
                                                <button
                                                    onClick={() => handleChatWithParent(
                                                        "MOTHER",
                                                        students.Parent.find(parent => parent.relation === "MOTHER")?.user?.username || "Undefined"
                                                    )}
                                                    className="px-3 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700"
                                                >
                                                    Написать
                                    ...
                                    {students?.Parent.some(parent => parent.relation === "CURATOR") && (
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center">
                                                    <FaUserGraduate className="w-5 h-5 text-gray-500"/>
                                                ...
                                                <button
                                                    onClick={() => handleChatWithParent(
                                                        "CURATOR",
                                                        students.Parent.find(parent => parent.relation === "CURATOR")?.user?.username || "Undefined"
                                                    )}
                                                    className="px-3 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700"
                                                >
                                                    Написать
                                            ...
                                            <div className="space-y-2">
                                                <p className="text-sm text-gray-600">
                                                    {students.Parent.find(parent => parent.relation === "CURATOR")?.user?.username}
                                                </p>
                                            </div>
                                        </div>
                                    )}
                                ...
                                <div className="text-gray-400 text-center">Undefined</div>
                            )}
            ...
            {activeTab === 'performance' && (
                <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-lg">
                        ...
                        <div className="grid grid-cols-3 gap-4 p-4">
                            ...
                            {students?.grades.length > 0 ? (
                                students.grades.map((subject, index) => (
                                    <div
                                        key={index}
                                            ...
                                            <div className="grid grid-cols-3 gap-2 mb-4 bg-gray-50 rounded-lg p-2">
                                                <div>
                                                    ...
                                                    <div className="text-lg font-medium text-gray-900">
                                                        {subject.grade !== undefined && subject.grade !== null ? subject.grade : 'Undefined'}
                                                    </div>
                                                </div>
                                            </div>
              ...
              `}>
                {subject.grade !== undefined && subject.grade !== null ? subject.grade : 'Undefined'}
                                ...
                                <div className="text-gray-400 text-sm">Оценок нет</div>
                            )}
                    ...
                    <div className="bg-white rounded-lg">
                        <div className="px-6 py-4 border-b border-gray-100">
                            <h2 className="text-lg font-medium text-gray-900">Персональный план
                                развития</h2>
                            <p className="text-sm text-gray-500">Цели и задачи для улучшения
                                успеваемости</p>
                        </div>
                        <div className="grid grid-cols-3 gap-4 p-4">
                                            ...
                                            <div className="space-y-1.5">
                                                {plan.tasks.map((task, idx) => (
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-1.5">
                                                            <div
                                                                className="w-1 h-1 rounded-full bg-gray-300"></div>
                                                            <span
                                                                className="text-xs text-gray-900">{task.title}</span>
                                                        </div>
                                                        <span
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white rounded-lg p-6">
                            <h3 className="text-base font-medium text-gray-900 mb-6">Динамика оценок по
                                предметам</h3>
                            <ResponsiveContainer width="100%" height={300}>
                                <LineChart data={performanceData}>
                        ...
                        <div className="bg-white rounded-lg p-6">
                            <h3 className="text-base font-medium text-gray-900 mb-6">Распределение
                                навыков</h3>
                            <ResponsiveContainer width="100%" height={300}>
            ...
            {activeTab === 'attendance' && (
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-6">Записи о посещаемости, медицинских визитах
                            и
                            пропусках</p>
                        <div className="grid grid-cols-1 gap-4">
                            {students?.Attendance && students.Attendance.length > 0 ? (
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-3">
                                                    <h3 className="text-sm font-medium text-gray-900">
                                                        {record.lesson?.name ? `Предмет: ${record.lesson.name}` : 'Предмет не указан'}
                                                    </h3>
                                                </div>
                                                <div className="text-right">
                                                    ...
                                                    <div className="text-xs text-gray-500">
                                                        {record.studentId ?? <span className="italic text-gray-400">Нет ID студента</span>}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="p-4 bg-gray-50 rounded-b-lg">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="text-sm">
                                                    ...
                                                    <p className="mt-1 text-gray-900">{record.status || 'Не указан'}</p>
                                                </div>
                                                <div className="text-sm">
                                                    <span className="text-gray-500">Подтверждено</span>
                                                    <p className="mt-1 text-gray-900">{record.studentId ?? 'Нет данных'}</p>
                                                </div>
                                                <div className="text-sm">
                                                ...
                                                <div className="text-sm col-span-2">
                                                    ...
                                                    <p className="mt-1 text-gray-900 italic">
                                                        {record.studentId ?? 'Комментарий отсутствует'}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="text-gray-400 text-sm">Нет данных по посещаемости</div>
                            )}
                    ...
                    <div className="bg-white rounded-xl p-6">
                        ...
                        <p className="text-sm text-gray-500 mb-6">Общая статистика и показатели
                            посещаемости</p>
                        <div className="grid grid-cols-4 gap-4 mb-8">
                            ...
                            <div
                                ...
                                <div
                                    className="text-2xl font-semibold text-red-600">{attendanceStats.total.absent}%
                                </div>
                            ...
                            <div
                                ...
                                <div
                                    className="text-2xl font-semibold text-yellow-600">{attendanceStats.total.late}%
                                </div>
                            ...
                            <div
                                ...
                                <div
                                    className="text-2xl font-semibold text-blue-600">{attendanceStats.total.medical}%
                                </div>
                        ...
                        <div>
                            <h3 className="text-sm font-medium text-gray-900 mb-4">Статистика по
                                предметам</h3>
                            <ResponsiveContainer width="100%" height={250}>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <div className="flex justify-between items-center mb-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Расписание занятий на текущую
                                    неделю</p>
                            </div>
                                        ...
                                        {day.lessons.map((lesson) => (
                                            ...
                                            >
                                                <div className="flex items-center justify-between mb-1">
                                                    <div className="flex items-center gap-2">
                                                                    <span
                                                                        className="text-sm font-medium">{lesson.time}</span>
                                                        <span
                                                            className="text-xs text-gray-500">({lesson.duration})</span>
                                                    </div>
                                                    <span
                                                        className="text-xs text-gray-500">Кабинет {lesson.room}</span>
                                                </div>
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <div
                                                            className="text-sm font-medium">{lesson.subject}</div>
                                                        <div
                                                            className="text-xs text-gray-500">{lesson.teacher}</div>
                                                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-right">
                                    ...
                                    <div
                                        className="text-2xl font-bold text-gray-900">{examSummary.ranking}</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-sm text-gray-500">Процент</div>
                                    <div
                                        className="text-2xl font-bold text-blue-600">{examSummary.percentage}%
                                    </div>
                                </div>
                                <div className="text-right">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            <div className="bg-white border border-gray-200 rounded-lg p-4">
                                ...
                                <div
                                    className="text-2xl font-bold text-gray-900">{filteredExamSummary.totalExams}</div>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-lg p-4">
                                <div className="text-sm text-gray-500 mb-1">Сдано</div>
                                <div
                                    className="text-2xl font-bold text-green-600">{filteredExamSummary.passed}</div>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-lg p-4">
                                <div className="text-sm text-gray-500 mb-1">Не сдано</div>
                                <div
                                    className="text-2xl font-bold text-red-600">{filteredExamSummary.failed}</div>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-lg p-4">
                            ...
                            <div
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-2 gap-6 mb-6">
                                        <div>
                                            ...
                                            <div
                                                className="text-base font-medium">{selectedExam.examType}</div>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <div className="text-sm text-gray-500 mb-1">Место проведения
                                            </div>
                                            <div
                                    ...
                                    <div className="mb-6">
                                        <h3 className="text-base font-medium mb-4">Результаты по
                                            разделам</h3>
                                        <div className="space-y-4">
                                            {selectedExam.details?.topics.map((topic, index) => (
                                                <div key={index}
                                                    ...
                                                    <div className="flex items-center justify-between mb-2">
                                                        <div
                                                            className="text-sm font-medium">{topic.name}</div>
                                                        <div className="text-sm">
                                ...
                                ({((topic.score / topic.maxScore) * 100).toFixed(1)}%)
                                                    ...
                                                    {topic.mistakes && topic.mistakes.length > 0 && (
                                                        <div className="mt-2">
                                                            <div
                                                                className="text-xs text-red-600 mb-1">Ошибки:
                                                            </div>
            ...
            {activeTab === 'extracurricular' && (
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <h2 className="text-xl font-medium text-gray-900 mb-1">Дополнительное
                            образование</h2>
                        ...
                        {getActivityStatusText(activity.status)}
                                        ...
                                        <div className="grid grid-cols-2 gap-4 mb-4">
                                            <div>
                                                ...
                                                <div
                                                    className="text-sm text-gray-900">{activity.schedule}</div>
                                            </div>
                                            <div>
                                                <div className="text-xs text-gray-500 mb-1">Место</div>
                                                <div
                                                    className="text-sm text-gray-900">{activity.location}</div>
                                            </div>
                                            {activity.members && (
                                                <div>
                                                    <div className="text-xs text-gray-500 mb-1">Участников
                                                    </div>
                                                    <div
                                                        className="text-sm text-gray-900">{activity.members}</div>
                                                </div>
                                            )}
                                            <div>
                                                <div className="text-xs text-gray-500 mb-1">Дата начала
                                                </div>
                                                <div
                                                    className="text-sm text-gray-900">{activity.startDate}</div>
                                            </div>
                                        </div>

                                        <div className="mb-4">
                                            <div className="text-xs text-gray-500 mb-2">Развиваемые навыки
                                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white rounded-xl shadow-md p-6">
                            <h3 className="text-lg font-medium text-gray-900 mb-4">Распределение
                                активностей</h3>
                            <ResponsiveContainer width="100%" height={300}>
                                <PieChart>
                                    <Pie
