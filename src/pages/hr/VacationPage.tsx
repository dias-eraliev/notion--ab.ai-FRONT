                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-xs focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      required
                    >
                      {vacationTypes.map(type => (
                        <option key={type.value} value={type.value}>
                          ...
                          {newVacation.document ? (
                            ...
                            <>
                              ...
                              <div className="flex text-sm text-gray-600">
                                <label
                                  htmlFor="file-upload"
                                  className="relative cursor-pointer rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-hidden"
                                >
                  ...
                  <div className="flex justify-end pt-4 border-t">
                    <button
                      type="button"
                      className="px-4 py-2 border border-gray-300 rounded-md shadow-xs text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 mr-3"
                      onClick={() => setIsNewVacationModalOpen(false)}
                    >
                      Отмена
                    </button>
