    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <label className="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-xs cursor-pointer flex items-center gap-2">
                      <FaUpload />
        ...
        <div className="col-span-1">
          <div className="bg-white rounded-lg shadow-xs p-6 sticky top-6">
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center gap-3 mb-4">
                  {previewLogo ? (
                    ...
                    <div className="w-8 h-8 bg-gray-200 rounded-xs" />
                  )}
                ...
                <div className="space-y-2">
                  <button
                    className="w-full py-2 px-4 rounded-xs"
