                ...
                <div className="border-t p-4">
                    <div className="relative rounded-lg border bg-white focus-within:ring-2 focus-within:ring-[#1C7E66]/20">
                        ...
                        <div className="flex flex-col items-center justify-between border-t p-2">
                            ...
                            <button onClick={handleSend} disabled={loading || (!input && files.length === 0)} className="mr-auto flex h-10 items-center gap-2 rounded-lg bg-[#1C7E66] px-4 text-white transition-colors hover:bg-[#1C7E66]/90 disabled:opacity-50">
                                Отправить
                                <Send size={16} />
                            </button>
                        </div>
